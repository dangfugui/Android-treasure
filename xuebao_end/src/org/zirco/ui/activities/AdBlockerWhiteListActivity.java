...
public class AdBlockerWhiteListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.come_web_adblocker_whitelist_activity);
	...
	private void fillData() {
    	...
    	mCursorAdapter = new SimpleCursorAdapter(this, R.layout.come_web_adblocker_whitelist_row, mCursor, from, to);
