...
public class MobileViewListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.come_web_mobile_view_list_activity);
	...
	private void fillData() {
    	...
    	mCursorAdapter = new SimpleCursorAdapter(this, R.layout.come_web_mobile_view_list_row, mCursor, from, to);
