...
public class EditBookmarkActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.come_web_edit_bookmark_activity);
        ...
        mOkButton.setOnClickListener(new View.OnClickListener() {			
			...
			public void onClick(View v) {				
				setAsBookmark();
				setResult(RESULT_OK);
				new WebData(getApplicationContext()).addweb(mTitleEditText.getText().toString(), mUrlEditText.getText().toString());
				finish();
			}
		});
