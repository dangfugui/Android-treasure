...
import com.diary.provider.SyncLogAdapter;
...
public class DiaryNew extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.com_diary_diary);
        ...
        String note=intent.getStringExtra("diary");
        if(note!=null){
        	mContentText.setText(note);
        }
	...
	private void saveState() {
		...
		Intent intent = new Intent(DiaryNew.this,DiaryMain.class);
