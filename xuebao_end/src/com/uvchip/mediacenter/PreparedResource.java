...
import com.dang.treasure.R.drawable;
...
public class PreparedResource {
    ...
    public PreparedResource(Context context){
        ...
        fileType.put(FILE_TYPE_AAC, R.drawable.file_aac);
        ...
        fileType.put(FILE_TYPE_HTML, R.drawable.file_html);       //html  
        ...
        fileType.put("xls", R.drawable.file_xls);
        loadDefaultMineType();
    }
