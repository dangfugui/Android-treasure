...
public class SoundRecorder extends Activity implements Button.OnClickListener,
    ...
    public void onCreate(Bundle icycle) {
        ...
        setContentView(R.layout.com_luyin_main);
        File file=new File(Data.Myrecordpath);
		if(!file.exists()){
			file.mkdirs();
		}
    ...
    private void initResourceRefs() {
        ...
        mFileNameEditText.setText("¼��"+date);
    ...
    protected void onResume() {
        super.onResume();
        stat.pageviewStart(this, "recorder");
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mRecorder.state() == Recorder.RECORDING_STATE
            ...
            getMenuInflater().inflate(R.layout.com_luyin_view_list_menu, menu);
            return true;
        }
    }
